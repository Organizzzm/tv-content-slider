...
Slider.prototype.bindEvents = function () {
    ...
    this.window.addEventListener('wheel', this.proxy(this.debouncedScrollController(), this));
};
...
Slider.prototype.debouncedScrollController = function () {
    return this.debounce(this.scrollController, 50, this.scrollController);
};
...
Slider.prototype.debounce = function (func, wait, immediate) {
    var timeout;
    return function () {
        var context = this,
            args = arguments;
